...
We are also simultaneously submitting a companion manuscript. In that manuscript, we utilized the same NIL population to test the hypothesis that \textit{Inv4m} drives adaptation via phosphorus use efficiency. That study proves that the inversion does \textit{not} alter the metabolic response to phosphorus starvation, a negative result that was critical in directing our focus toward the developmental timing mechanisms detailed here. 
